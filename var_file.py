...
link_xsmb = "https://xsmb.dungpa45.cf/api"
...
l_antrua = ['cơm rang', 'bún vịt', 'cơm rang ngan', 'bún đậu', 'xôi', 'bún chả','bánh cuốn',
            'mỳ vằn thắn', 'bún pò', 'cơm thố', 'phở pò','cơm trộn','nem nướng',
            'bún ngan','cơm gà','cơm tầng 3','de faifo','cơm ĐHQG','cơm tù']
#################################################################
